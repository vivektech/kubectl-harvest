...
func ObjectToSecret(obj runtime.Object) (*corev1.Secret, error) {
	u, err := toUnstructured(obj)
	if err != nil {
		return nil, err
	}
	...
	if err := fromUnstructured(u, &secret); err != nil {
		return nil, err
	}
...
func ObjectToPodDisruptionBudget(obj runtime.Object) (*policyv1.PodDisruptionBudget, error) {
	u, err := toUnstructured(obj)
	if err != nil {
		return nil, err
	}
